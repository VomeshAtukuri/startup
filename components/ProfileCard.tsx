...
export default function ProfileCard({
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="bg-white py-3 px-6 rounded-xl text-center border-2 border-black shadow-md -mb-6 z-10 dark:bg-gray-800">
      ...
      <div
        className="w-[280px] bg-gradient-to-b from-[#f03a7a] to-[#d92663] rounded-[40px] overflow-hidden border-4 
                      border-r-[6px] border-b-[6px] border-black"
      >
