...
export default function ProfileCard({
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div
        className="w-[280px] bg-gradient-to-b from-[#f03a7a] to-[#d92663] rounded-[40px] overflow-hidden border-2
                      border-r-[4px] border-b-[4px] border-black dark:border-white  shadow-lg"
      >
        <div className="pt-8 pb-6 px-6 flex flex-col items-center">
          ...
          <p className="text-[12px] text-foreground opacity-90 mb-4 text-center">
            {getRandomBio()}
          </p>
          ...
          <div className="flex justify-between w-full px-6 mt-2 ">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold">{totalViews || 0}</span>
            </div>
